		...
		boolean checkStrWithMiddle = false;
		 for (int len = 1; len <= n; len++) {
	            for (int i = 0; i <= n - len; i++) {
	                ...
	                String temp = "";
	                for (int k = i; k <= j; k++) {
//	            		checkDuplicate = getDuplicate(String.valueOf(str[k]));
//	            		checkStrWithMiddle = checkStrWithMiddleChar(String.valueOf(str[k]));
...
//            		System.out.print("   checkDuplicate = " + checkDuplicate + " , checkStrWithMiddle = " + checkStrWithMiddle);
